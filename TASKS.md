...
- [x] **H12-03**  
  ...
  `Definition of Done:` Normal builds now always write a shadow `section_outline_llm.json` artifact backed by H12 evidence, internal `section_planning_mode="llm"` runs can drive H6-H9 from that unified outline, and H10 can compare `semantic-structure-context` against `semantic-structure-context-llm-section-planning` before any public promotion.
