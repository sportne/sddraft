...
MODULES = (
    ...
    "engllm.tools.history_docs.algorithm_capsule_enrichment",
    ...
    "engllm.tools.history_docs.draft_review",
    "engllm.tools.history_docs.dependency_landscape",
    "engllm.tools.history_docs.dependencies",
    "engllm.tools.history_docs.delta",
    "engllm.tools.history_docs.h13_evidence",
    "engllm.tools.history_docs.interface_inventory",
    ...
    "engllm.tools.history_docs.section_drafting_llm",
    "engllm.tools.history_docs.section_planning_llm",
    "engllm.tools.history_docs.section_outline",
    "engllm.tools.history_docs.section_repair_llm",
