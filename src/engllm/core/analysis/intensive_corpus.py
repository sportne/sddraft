...
from engllm.core.analysis.retrieval import tokenize
from engllm.core.repo.scanner import discover_source_files
...
_CORPUS_DIRNAME = "intensive/corpus"
...
def default_intensive_runs_root(output_root: Path) -> Path:
    ...
    return output_root / "intensive" / "runs"
