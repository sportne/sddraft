...
`ask` uses `retrieval_index.json` and, when present, expands evidence with
...
sddraft ask --index-path artifacts/SDDRAFT_CORE/retrieval_index.json --question "What are the main workflows in this project?" --provider mock
...
sddraft ask --index-path artifacts/SDDRAFT_CORE/retrieval_index.json --question "What are the main workflows in this project?" --provider ollama --model qwen2.5:14b-instruct-q4_K_M
sddraft inspect-diff --commit-range HEAD~1..HEAD --repo-root .
